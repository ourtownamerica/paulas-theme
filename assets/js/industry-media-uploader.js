jQuery(document).ready(function($) {
    ...
    var metaBox = $('.industry-image-upload-wrapper');
    ...
    metaBox.on('click', '.upload-image-button', function(e) {
        ...
        imageFrame.on('select', function() {
            ...
            $('#industry_image_id').val(attachment.id);

            // Update the image preview
            $('.industry-image-preview').html('<img src="' + attachment.url + '" alt="Image Preview" />');
    ...
    metaBox.on('click', '.remove-image-button', function() {
        ...
        $('#industry_image_id').val('');

        // Clear the image preview
        $('.industry-image-preview').html('');
